...
coord_start_time=2018-12-20T05:00+0300
coord_end_time=2028-10-18T05:10+0300

# Oracle Section
connection_string="jdbc:sqlserver://bpdb-reader"
ORA_USER=TECH_HADOOP
ORA_PASSWORD="REDACTED"

DATABASE=s_sourcedata
TMP_DATABASE=s_sourcedata
PATH_TO_TMP=/storage/s_sourcedata/db
TMP_TABLE_TYPE=tmp
...
workflow_application_path=${wf_reg_path}/wf_reg_rcndo_lm_weekly
